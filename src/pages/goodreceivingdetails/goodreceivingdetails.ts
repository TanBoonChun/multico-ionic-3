...
/**
 * Generated class for the GoodreceivingdetailsPage page.
 *
...
// @IonicPage()
@Component({
  selector: 'page-goodreceivingdetails',
  templateUrl: 'goodreceivingdetails.html',
})
export class GoodreceivingdetailsPage {
  Id:any;
  Type:any='';
  Receiving_No:any='';
  PO_No:any='';
  ...
  loadData(){
    ...
    this.storage.get("token").then((val) => {
      ...
      data.subscribe((result) => {
        ...
        console.log(this.b[0].Inventory_Id)
