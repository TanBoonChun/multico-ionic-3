...
@IonicPage()
@Component({
  selector: 'page-sitecodeapproval',
  templateUrl: 'sitecodeapproval.html',
})
export class SitecodeapprovalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad SitecodeapprovalPage');
    ...
    const confirm = this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            // let nav = this.app.getRootNav();
            // nav.push(this.listdetailspage, item)
